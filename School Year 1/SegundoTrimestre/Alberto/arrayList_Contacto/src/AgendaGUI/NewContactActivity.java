 ...
 * @author super
 */
public class NewContactActivity extends javax.swing.JFrame {
    
    /**
     * Creates new form NewContactActivity
     */
    ...
    public static void mainGUI() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewContactActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewContactActivity().setVisible(true);
            }
        });
    }
